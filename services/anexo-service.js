 ...
 */
exports.searchAttachmentByParam = async (param) => {
    ...
    try {
        ...
        const query = `select * from search_attachment_by_param ($1) as result;`;
...
exports.upsertAttachment = async (object) => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select upsert_attachment($1) as result;`;
...
exports.deleteAttchment = async (id) => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select delete_attachment($1) as result;`;
