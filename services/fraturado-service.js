...
exports.findFraturadoSystemByPoint = async (latitude, longitude) => {
    ...
    try {
        ...
        const query = `select * from find_fraturado_system_by_point($1, $2) as result;`;
...
exports.listAllHydrogeoFraturado = async () => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select * from list_all_hidrogeo_fraturado() as result;`;
