 ...
 */
exports.listAllHydrographicBasins = async () => {
    ...
    try {
        ...
        const query = `select * from list_all_hydrographic_basins() as result;`;
...
exports.findHydrographicBasinByPoint = async (latitude, longitude) => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select * from find_hydrographic_basin_by_point($1, $2) as result;`;
