 ...
 */
exports.searchProcessByParam = async (param) => {
    ...
    try {
        ...
        const query = `select * from search_process_by_param ($1) as result;`;
...
exports.upsertProcess = async (object) => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select upsert_process($1) as result;`;
...
exports.deleteProcess = async (id) => {
    ...
    try {
        ...
        // Define a query SQL chamando a função PostgreSQL que realiza a busca
        const query = `select delete_process($1) as result;`;
